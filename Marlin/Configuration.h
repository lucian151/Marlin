...
#define CUSTOM_MENDEL_NAME "Mandelbot"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {78.7402*100/78.7,(78.7402*(100/39.15)),200.0*8/3*50/67,760*1.1}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {500, 500, 20, 50}    // (mm/sec)
